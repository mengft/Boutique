...
import { LoadView, ItemSeparator } from './index';
import { px2dp, Colors, FontSize } from '../Theme';
import * as Config from '../Config';

const HEADER_HEIGHT = px2dp(140);
const HEADER_MAX_HEIGHT = px2dp(160);
					...
					{typeof this.props.refreshControl !== 'function'
						? (
							<View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
								<Image source={require('../Assets/Images/Component/loading-triangles.gif')} style={{ width: px2dp(70), height: px2dp(70) }} />
...
const Styles = StyleSheet.create({
	warnText: { color: Colors.C5, fontSize: FontSize(20), marginTop: px2dp(4) },
});
